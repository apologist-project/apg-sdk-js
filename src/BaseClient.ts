...
export type BaseClientOptions = {
    environment?: core.Supplier<environments.ApologistAgentEnvironment | string>;
    /** Specify a custom URL to connect the client to. */
    baseUrl?: core.Supplier<string>;
    /** Defaults to "your-agent-domain.com". */
    domain?: string;
...
export function normalizeClientOptions<T extends BaseClientOptions = BaseClientOptions>(
    ...
    const headers = mergeHeaders(
        {
            ...
            "User-Agent": "apologist-agent/0.0.3",
    ...
    if (options?.domain != null) {
        const _domain = options?.domain ?? "your-agent-domain.com";
        if (baseUrl == null) {
            const _environmentUrls = new Map<unknown, string>([
                [environments.ApologistAgentEnvironment.Default, `https://${_domain}/api/v1`],
            ]);
            baseUrl = _environmentUrls.get(options?.environment) ?? `https://${_domain}/api/v1`;
        }
    }
